...
namespace MultiLanguageTK
{
    ...
    {
        [HideInInspector] [SerializeField] public string SheetName = "";

        [HideInInspector] [SerializeField] public string WorksheetName = "";

        // Note: initialize in OnEnable() not here.
        public TranslationData[] dataArray;
...
//#endif
            ...
            // 
            if (dataArray == null)
                dataArray = new TranslationData[0];
        }

        //
        // Write a proper query methods for retrieving data.
        //
        //public TranslationData FindByKey(string key)
        //{
